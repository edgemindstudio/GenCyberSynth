# src/gencysynth/models/gaussianmixture/variants/c-gmm-full/model.py
"""
GenCyberSynth — GaussianMixture — c-gmm-full — Model Utilities
=============================================================
...
This file should remain import-safe (NumPy + sklearn only) and reusable across
datasets and variants.

Conventions
-----------
- Images are channels-last: (N, H, W, C)
- Pixel range is expected to be [0, 1] float32 for training.
  If legacy arrays are 0..255, we auto-normalize when `assume_01=True`.
"""
...
def flatten_images(
    ...
    *,
    ...
    ----------
    x : np.ndarray
        Input images or already-flattened array.
    ...
    assume_01 : bool
        Whether to auto-normalize from 0..255 to 0..1 when needed.
    clip : bool
...
def sample_gmm_images(
    ...
    *,
    ...
    - GMM sampling can produce small out-of-range values; clipping is a safety guard.
