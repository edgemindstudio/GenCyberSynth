# src/gencysynth/adapters/models/autoregressive/stub.py
...
from gencysynth.adapters.models.autoregressive.base import AutoregressiveAdapterBase
from gencysynth.adapters.models.base import TrainResult
from gencysynth.adapters.datasets.splits import DatasetSplits


class AutoregressiveStubAdapter(AutoregressiveAdapterBase):
