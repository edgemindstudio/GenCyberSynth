# src/gencysynth/adapters/models/diffusion/stub.py
...
from gencysynth.adapters.models.diffusion.base import DiffusionAdapterBase
from gencysynth.adapters.models.base import TrainResult
from gencysynth.adapters.datasets.splits import DatasetSplits


class DiffusionStubAdapter(DiffusionAdapterBase):
