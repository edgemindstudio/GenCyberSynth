# src/gencysynth/adapters/models/gaussianmixture/variants/gmm_diag/adapter.py
...
class GMMDiagAdapter(GaussianMixtureAdapterBase):
    def __init__(self):
        super().__init__(variant="gmm_diag", description="Class_conditional sklearn GaussianMixture (diag cov)")
